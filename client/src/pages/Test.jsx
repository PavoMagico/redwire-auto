...
const preguntas = [
  { categoria: 'Estilo de vida', pregunta: '¿Cuál es tu situación familiar?', campo: 'familia',
    opciones: [
  ...
  { categoria: 'Uso del vehículo', pregunta: '¿Para qué usarás el coche principalmente?', campo: 'uso',
    opciones: [
  ...
  { categoria: 'Preferencias técnicas', pregunta: '¿Qué tipo de motor prefieres?', campo: 'motor',
    opciones: [
  ...
  { categoria: 'Preferencias técnicas', pregunta: '¿Cuántas plazas necesitas como mínimo?', campo: 'plazas',
    opciones: [
      { label: '2 plazas (solo yo)',  value: 2 },
      { label: '5 plazas (estándar)', value: 5 },
      { label: '7 plazas o más',      value: 7 },
    ]},
  { categoria: 'Presupuesto', pregunta: '¿Cuál es tu presupuesto máximo?', campo: 'presupuesto',
    opciones: [
  ...
  { categoria: 'Medioambiente', pregunta: '¿Te importa la etiqueta ambiental?', campo: 'etiqueta',
    opciones: [
    ...
    <div className="page" style={{ maxWidth: 640, marginTop: 40 }}>
      <div style={{ textAlign: 'center', marginBottom: 32 }}>
        <p style={{ fontSize: 13, color: 'var(--gris)', marginBottom: 6 }}>
          Pregunta {paso + 1} de {preguntas.length} · {actual.categoria}
        </p>
      ...
      <div style={{ display: 'flex', flexDirection: 'column', gap: 12 }}>
        {actual.opciones.map(op => (
          <button key={op.value} onClick={() => handleRespuesta(op.value)}
            style={{ padding: '18px 24px', fontSize: 16, fontWeight: 500, background: 'white',
              border: '2px solid var(--border)', borderRadius: 12, textAlign: 'left', cursor: 'pointer', transition: 'all .15s' }}
